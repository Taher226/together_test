...
class _ProgramDetailsState extends State<ProgramDetails> {
  var selectedProgramType = 1;
  var selectedFrequentType = 1;

  var selectedPlan = 1;
  var isDetailedProgram = true;
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage('images/zakat.png'),
              fit: BoxFit.cover,
              colorFilter: ColorFilter.mode(
                AppColors.primary.withOpacity(0.8), // Blue overlay with opacity
                BlendMode
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount: programType.length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (context, i) {
                          return InkWell(
                            onTap: () {
                              setState(() {
                                selectedProgramType = programType[i]['id'];
                              });
                            },
                            child: Container(
                              decoration: BoxDecoration(
                        ...
                        ? Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                'You can sponsor an orphan in palestine and give them a chance to live a better life',
                                style: TextStyle(
                                  fontSize: 14,
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 10),
                                        Text(
                                          '${plans.firstWhere((plan) => plan['id'] == selectedPlan)['name']}',
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w600,
                                            color: AppColors.neutral20,
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                ...
                                print('value is ${inputController.text}');
                              },
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w700,
